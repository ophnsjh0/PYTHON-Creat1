...
class Arista:
    def __init__(self, switch):
        ...
        self.cmd = [' term length 0', 'show logging', 'show interface status', 'show interface counters',
                    'show interface count error', 'show ip route', 'show module', 'show processes top once', 'show mlag detail', 
                    'show environment temperature', 'show environment power', 'show environment cooling', 'show spanning-tree', 
                    'show ntp associations', 'exit']
